...
public class ReverseAlbumLookupTask extends AsyncTask<String, Integer, String> {
	...
	public ReverseAlbumLookupTask(SearchResultsActivity u, String loadingMsg) {
		searchResultActivity = u;
		this.msg = loadingMsg;
	}
	
	public ReverseAlbumLookupTask() {
		appContext = null;
	}
	...
	protected String doInBackground(String... params) {
		...
		response = httpRequest("http://billboard-jpblair.herokuapp.com/reverse/album", "GET", "artist", params[0], "album", params[1], "startDate", params[2], "endDate", params[3]);
